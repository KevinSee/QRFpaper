...
```{r corr-fig, eval = T, results='hide', out.width = "50%", fig.show = "hold", fig.cap = "Correlation plots of metrics, faceted by habitat category. Larger circles correspond to larger correlation coefficients. The colors correspond to the correlation coefficient as well, and range from blue (-1) to white (0) to red (1)."}
...
# for(i in 1:nrow(cor_plot_df)) {
#   print(cor_plot_df$cor_plot[i])
# }
cor_plot_df$cor_plot

# cowplot::plot_grid(plotlist = cor_plot_df$cor_plot,
#                    ncol = 2)
