...
```{r corr-fig, eval = T, results='hide', out.width = "90%", fig.show = "hold", fig.cap = "Correlation plots of metrics, faceted by habitat category. Larger circles correspond to larger correlation coefficients. The colors correspond to the correlation coefficient as well, and range from blue (-1) to white (0) to red (1)."}
